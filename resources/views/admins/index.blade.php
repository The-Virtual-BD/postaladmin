    ...
    <div id="main" class="main-content flex-1 bg-gray-100 pb-24 md:pb-5">
        ...
        <div class="shadow flex justify-between items-center">
            <div class="p-4  text-2xl">
                <h1 class="font-bold pl-2">Admins</h1>
            </div>
            <div class="p-4">
                <a href="{{ route('admins.create') }}"><button class="py-1 px-2 rounded bg-blue-500 text-white">Create
                        Admin</button></a>
            </div>
        </div>
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            data.roles.forEach((role)=> {
                                roles += `<span class="px-2 py-1 bg-green-200 mx-1 rounded-full capitalize">${role.name}</span>`
                            });
                            return roles;
