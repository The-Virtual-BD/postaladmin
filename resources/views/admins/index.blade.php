                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data) {
                                ...
                                return `<div class="flex"><a href="${BASE_URL}admins/show/${data.id}" class="bg-blue-600 rounded-md text-white py-2 px-2 mx-1 hover:bg-blue-700"><span class="iconify" data-icon="carbon:view-filled"></span></a>
